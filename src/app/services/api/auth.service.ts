...
export const ACCESS_TOKEN_KEY = 'cynologistPlus_access_token'
...
export class AuthService {
    ...
    isCurrentUserClient() : boolean {
        if(this.getUserInfoFromToken().role.toLowerCase() == "client") {
            return true;
        }
        return false;
    }
    ...
    isCurrentUserAdmin() : boolean {
        if(this.getUserInfoFromToken().role.toLowerCase() == "admin") {
            return true;
        }
        return false;
    }
